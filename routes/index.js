const getIndex = require('../collection/getIndex');  //网站首页逻辑
const userLogin = require('../collection/userLogin'); //用户登录逻辑
const validateLogin = require('../collection/islogin');  //用户权限控制
const engine = require('../collection/engine');         //机房管理
const use = require('../collection/use');               //用途管理
const cabinets = require('../collection/cabinets');      //机柜管理
const ip = require('../collection/ip');                  //ip地址池管理
const server = require('../collection/server');          //服务器管理
const user = require('../collection/users');             //用户管理
const skillfully = require('../collection/skillfully');  //财务管理
//idc_cms 路由文件
